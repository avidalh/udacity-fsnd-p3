...
#Category 3
    ...
    car2 = Items( 
        ...
        the Toyota Corolla. Introduced in 2006, the first generation shared \
        the E150 platform with the Corolla, while the second generation \
        compact five-door hatchback and station wagon called the Touring \
        Sports uses the E180 platform. The name Auris is based on the Latin \
        word for gold, aurum.In Europe, Toyota positioned the Auris as the \
        replacement for the Corolla hatchback, while the notchback sedan \
        continued with the Corolla nameplate. It was not sold in North \
        America, as the larger Toyota Matrix had taken its place in the lineup \
        prior to its discontinuation in 2014. For the first generation only, \
        the more luxurious Auris was named Toyota Blade in Japan. The Auris \
        ...
        picture1 = "http://hybridcars2016.com/wp-content/uploads/2015-Toyota-Auris-Hybrid.jpg",
        picture2 = "http://hybridcars2016.com/wp-content/uploads/2015-Toyota-Auris-Hybrid-interior.jpg",
        picture3 = "http://hybridcars2016.com/wp-content/uploads/2015-Toyota-Auris-Hybrid-engine.jpg",
